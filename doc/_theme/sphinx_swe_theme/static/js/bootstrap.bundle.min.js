...
!function(t, e) {
	...
	"function" == typeof define && define.amd ?
				...
				Object.keys(i).forEach((n => {
					...
					if (!new RegExp(s).test(a))
						throw new TypeError(`${t.toUpperCase()}: Option "${
							n}" provided type "${
							a}" but expected type "${s}".`)
				}))
			},
		l = t => !(!o(t) || 0 === t.getClientRects().length) &&
		  ...
		  trigger(t, e, i) {
			  ...
			  return o && n &&
				 ...
				 r ? (d = document.createEvent("HTMLEvents"),
				     ...
				     void 0 !== i && Object.keys(i).forEach((
	  ...
	  const U = {
		...
		tt = { ArrowLeft: J, ArrowRight: Z }, et = "slid.bs.carousel", it = "active",
	  ...
	  class st extends B {
		  ...
		  _addEventListeners()
		  {
			  this._config.keyboard && j.on(this._element, "keydown.bs.carousel",
							(t => this._keydown(t))),
		  ...
		  _addTouchEventListeners()
		  {
			  ...
			  V.find(".carousel-item img", this._element)
				  .forEach((t => { j.on(t, "dragstart.bs.carousel",
							(t => t.preventDefault())) })),
				  this._pointerEvent ?
					  (j.on(this._element, "pointerdown.bs.carousel",
						(t => e(t))),
					   j.on(this._element, "pointerup.bs.carousel",
						(t => n(t))),
					   this._element.classList.add("pointer-event")) :
						(j.on(this._element, "touchstart.bs.carousel",
						(t => e(t))),
					   j.on(this._element, "touchmove.bs.carousel",
						(t => i(t))),
		  ...
		  _setActiveIndicatorElement(t)
		  {
			  if (this._indicatorsElement) {
				  ...
				  for (let e = 0; e < i.length; e++)
					  if (Number.parseInt(i[e].getAttribute("data-bs-slide-to"),
	  ...
	  const ot = "collapse", rt = { toggle: !0, parent: null },
		...
		ht = "collapsing", dt = "collapsed", ut = ":scope .collapse .collapse",
	  ...
	  var mt = "top", gt = "bottom", _t = "right", bt = "left", vt = "auto",
	      ...
	      kt = yt.reduce((function(t, e) {
			     ...
			     []),
	      Lt = [].concat(yt, [vt]).reduce(
		      (function(t, e) {
			      return t.concat([e, e + "-" + wt, e + "-" + Et])
		      }),
		      []),
	      xt = "beforeRead", Dt = "read", St = "afterRead", Nt = "beforeMain", It = "main",
	      Pt = "afterMain", jt = "beforeWrite", Mt = "write", Ht = "afterWrite",
				 ...
				 function() {
					 Object.keys(e.elements).forEach((function(t) {
						 var n = e.elements[t], s = e.attributes[t] || {},
						     o = Object.keys(e.styles.hasOwnProperty(t) ?
									     e.styles[t] :
										   i[t])
								 .reduce((function(t, e) {
										 return t[e] = "", t
		  ...
		  fn: function(t) {
			  ...
			  null != e.modifiersData.popperOffsets &&
				  (e.styles.popper = Object.assign(
					   {}, e.styles.popper, de(Object.assign({}, c, {
	  ...
	  function Ae(t, e)
	  {
		  ...
		  var n = Ee(t), s = n === (null == (i = t.ownerDocument) ? void 0 : i.body),
		      o = Wt(n), r = s ? [o].concat(o.visualViewport || [], we(n) ? n : []) : n,
		      a = e.concat(r);
		  ...
		  return e === Tt ? Te(function(t) {
			 ...
			 zt(e) ?
				    function(t) {
					  ...
					  Te(function(t) {
					    var e, i = Gt(t), n = ve(t),
						   s = null == (e = t.ownerDocument) ? void 0 :
											     e.body,
	  ...
	  function Ce(t)
	  {
		  var e, i = t.reference, n = t.element, s = t.placement, o = s ? Ut(s) : null,
			 r = s ? ce(s) : null, a = i.x + i.width / 2 - n.width / 2,
	  ...
	  function ke(t, e)
	  {
		  ...
		  var i = e, n = i.placement, s = void 0 === n ? t.placement : n, o = i.boundary,
		      r = void 0 === o ? At : o, a = i.rootBoundary, l = void 0 === a ? Tt : a,
		      c = i.elementContext, h = void 0 === c ? Ot : c, d = i.altBoundary,
		      u = void 0 !== d && d, f = i.padding, p = void 0 === f ? 0 : f,
	  ...
	  function Le(t, e)
	  {
		  ...
		  var i = e, n = i.placement, s = i.boundary, o = i.rootBoundary, r = i.padding,
		      a = i.flipVariations, l = i.allowedAutoPlacements, c = void 0 === l ? Lt : l,
		      h = ce(n),
	  ...
	  const Fe = Object.freeze({
		...
		ri = m() ? "left-start" : "right-start", ai = m() ? "right-start" : "left-start",
		li = {
			offset: [0, 2],
	  ...
	  const vi = { trapElement: null, autofocus: !0 },
		yi = { trapElement: "element", autofocus: "boolean" }, wi = ".bs.focustrap",
		Ei = "backward";
	  class Ai {
		  constructor(t)
		  {
			  ...
			  this._isShown || this._isTransitioning || j.trigger(this._element, xi, {
				  ...
				  (this._isShown = !0,
				   ...
				   j.on(this._dialog, Ii,
					(() => { j.one(
						 this._element, "mouseup.dismiss.bs.modal",
	  ...
	  const Bi = "offcanvas", Ri = { backdrop: !0, keyboard: !0, scroll: !1 },
		Wi = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" }, $i = "show",
		zi = ".offcanvas.show", qi = "hidden.bs.offcanvas";
	  class Fi extends B {
		  constructor(t, e)
		  {
		  ...
		  _addEventListeners()
		  {
			  j.on(this._element, "keydown.dismiss.bs.offcanvas",
	  ...
	  const Qi = "tooltip", Gi = new Set(["sanitize", "allowList", "sanitizeFn"]), Zi = {
		...
		nn = "fade", sn = "show", on = "show", rn = "out", an = ".tooltip-inner",
		ln = ".modal", cn = "hide.bs.modal", hn = "hover", dn = "focus";
	  class un extends B {
		  constructor(t, e)
		  {
			  if (void 0 === Fe)
			  ...
			  super(t), this._isEnabled = !0, this._timeout = 0, this._hoverState = "",
				    ...
				    this._config = this._getConfig(e), this.tip = null,
				    this._setListeners()
		  }
		  static get Default()
		  {
		  ...
		  show()
		  {
			  ...
			  H.set(n, this.constructor.DATA_KEY, this),
				  this._element.ownerDocument.documentElement.contains(this.tip) ||
					  (a.append(n), j.trigger(this._element,
								  this.constructor.Event.INSERTED)),
				  this._popper ? this._popper.update() :
						       this._popper = qe(this._element, n,
	  ...
	  class gn extends un {
		  ...
		  setContent(t)
		  {
			  this._sanitizeAndSetContent(t, this.getTitle(), ".popover-header"),
				  this._sanitizeAndSetContent(t, this._getContent(),
							      ".popover-body")
		  }
		  _getContent()
		  {
	  ...
	  class xn extends B {
		  ...
		  _transitionComplete(t, e, i)
		  {
			  if (e) {
				  ...
				  const t = V.findOne(":scope > .dropdown-menu .active",
						      e.parentNode);
			  ...
			  if (n && "LI" === n.nodeName && (n = n.parentNode),
				  ...
				  e && V.find(".dropdown-toggle",
					      e).forEach((t => t.classList.add(Tn))),
		  ...
		  _maybeScheduleHide()
		  {
			  this._config.autohide &&
				  (this._hasMouseInteraction || this._hasKeyboardInteraction ||
				   (this._timeout = setTimeout((() => { this.hide() }),
							       this._config.delay)))
		  }
		  _onInteraction(t, e)
		  {
	  ...
	  return R(Mn), g(Mn),
	  {
		  Alert: W, Button: z, Carousel: st, Collapse: pt, Dropdown: hi, Modal: Hi,
			  Offcanvas: Fi, Popover: gn, ScrollSpy: An, Tab: xn, Toast: Mn, Tooltip: un
	  }
  }));
