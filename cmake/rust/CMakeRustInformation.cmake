...
#
# Options: -h --help           Display this message --cfg SPEC Configure the
# compilation environment -L [KIND=]PATH      Add a directory to the library
# search path. The optional KIND can be one of dependency, crate, native,
# framework or all (the default). -l [KIND=]NAME      Link the generated
# crate(s) to the specified native library NAME. The optional KIND can be one of
# static, dylib, or framework. If omitted, dylib is assumed. --crate-type
# [bin|lib|rlib|dylib|cdylib|staticlib|metadata] Comma separated list of types
...
# --allow OPT      Set lint allowed -D --deny OPT       Set lint denied -F
# --forbid OPT     Set lint forbidden --cap-lints LEVEL   Set the most
# restrictive lint level. More restrictive lints are capped at this level -C
# --codegen OPT[=VALUE] Set a codegen option -V --version        Print version
# info and exit -v --verbose        Use verbose output
#
# Additional help: -C help             Print codegen options -W help Print
# 'lint' options and default settings -Z help             Print internal options
# for debugging rustc --help -v           Print the full set of options rustc
# accepts
#

# <TARGET> <TARGET_BASE> <OBJECT> <OBJECTS> <LINK_LIBRARIES> <FLAGS>
# <LINK_FLAGS> <SOURCE> <SOURCES>
...
if(NOT CMAKE_Rust_CREATE_SHARED_LIBRARY)
  set(CMAKE_Rust_CREATE_SHARED_LIBRARY
      "echo \"CMAKE_Rust_CREATE_SHARED_LIBRARY\"" "${CMAKE_Rust_ECHO_ALL}")
endif()
...
if(NOT CMAKE_Rust_COMPILE_OBJECT)
  set(CMAKE_Rust_COMPILE_OBJECT
      "echo \"CMAKE_Rust_COMPILE_OBJECT\"" "${CMAKE_Rust_ECHO_ALL}"
      "${CMAKE_Rust_COMPILER} --emit obj <SOURCE> -o <OBJECT>")
endif()

if(NOT CMAKE_Rust_LINK_EXECUTABLE)
  set(CMAKE_Rust_LINK_EXECUTABLE "echo \"CMAKE_Rust_LINK_EXECUTABLE\""
                                 "${CMAKE_Rust_ECHO_ALL}")
endif()

mark_as_advanced(
  CMAKE_Rust_FLAGS CMAKE_Rust_FLAGS_DEBUG CMAKE_Rust_FLAGS_MINSIZEREL
  CMAKE_Rust_FLAGS_RELEASE CMAKE_Rust_FLAGS_RELWITHDEBINFO)
