...
find_program(
  RUST_LLDB_EXECUTABLE rust-lldb
  HINTS "${CARGO_HOME}"
  PATH_SUFFIXES "bin")
...
if(CARGO_EXECUTABLE
  ...
  set(CARGO_HOME
      "${CARGO_HOME}"
      CACHE PATH "Rust Cargo Home")

  execute_process(
    COMMAND ${RUSTC_EXECUTABLE} --version
    OUTPUT_VARIABLE RUSTC_VERSION
    OUTPUT_STRIP_TRAILING_WHITESPACE)
  string(REGEX REPLACE "rustc ([^ ]+) .*" "\\1" RUSTC_VERSION
                       "${RUSTC_VERSION}")
endif()
